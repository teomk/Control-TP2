...
\begin{itemize}
    ...
    \item La respuesta es rápida debido a la ubicación de los polos en $[-1.5,\,-2.0,\,-2.5,\,-3.0]$.
    \item El costo de esa rapidez es una señal de control elevada, con $\max |\tau_r| = 18.5989$.
    \item La señal de control presenta picos importantes en los instantes de cambio de referencia. Esto puede ser problemático si el actuador real tiene límites de saturación o restricciones de potencia.
    \item Si los polos se ubicaran más a la izquierda, la respuesta sería más rápida, pero aumentaría el esfuerzo de control y podrían aparecer transitorios más bruscos. Si se ubicaran más cerca del origen, la respuesta sería más lenta y suave, con menor exigencia sobre el actuador.
\end{itemize}
